...
<HStack style={{ justifyContent: "center", padding: "5%", textAlign:"center" , width:"100%"}}>
  ...
  {/* Move this VStack to be the first element in the HStack */}
  <VStack
    md={5}
  ...
  >
    ...
    <img src={laptopImg} alt="about" className="img-fluid" width={"150%"} />
    </AnimationOnScroll>
  </VStack>

  {/* Move this VStack to be the second element */}
  <VStack
    style={{
      justifyContent: "center",
      paddingTop: "30px",
  ...
  {/* Move the photo VStack to be the first item */}
  <VStack
    md={5}
    style={{width:"90%"}}
    className="about-img"
  ...
  {/* Move the text VStack to be the second item */}
  <VStack
    style={{
      justifyContent: "center",
      display:"inline-block",
