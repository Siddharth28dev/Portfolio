...
const socials = [
  {
    icon: faEnvelope,
    url: "mailto: shivsrivastav582@gmail.com",
  },
  {
    icon: faGithub,
    url: "https://github.com/student-uit",
  },
  {
    icon: faLinkedin,
    url: "https://www.linkedin.com/in/Siddharth Srivastava",
  },
  // {
  //   icon: faTwitter,
  ...
  // {
  //   icon: SiLeetcode,
  //   url: "https://leetcode.com/sidSrivastava9/",
  // },
];
    ...
    <Box className="mainSection2">
      ...
      <Flex
        ...
        <Flex
          ...
          paddingBottom="2%"
        >
          {/* <p>Siddharth Srivastava AKA TechyBuffoon • © 2022</p> */}
          <h3>shivsrivastav582@gmail.com</h3>
        </Flex>
        </MediaQuery>
